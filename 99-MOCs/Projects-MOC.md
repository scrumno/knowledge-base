...
> Навигация по всем активным и завершенным проектам
...
*Проекты будут перемещены в `04-Archive/` после завершения*

---

## 📝 ШАБЛОНЫ

Для создания нового проекта используйте [[Project-Template|шаблон проекта]]

---

## 🔗 СВЯЗАННЫЕ MOCs

- [[Learning-MOC|Learning-MOC]] — проекты связанные с обучением
- [[Life-MOC|Life-MOC]] — личные проекты и цели
